        ...
        <div className="container px-5 py-10 mx-auto text-center lg:px-40">
            <div className="flex flex-col w-full mb-20">
                ...
                <p className="mx-auto leading-relaxed">
                    As a programmer, although my focus is primarily in games and web development, I enjoy tinkering and programming in many different ways. I enjoy learning new technologies and experimenting with various SDKs and APIs, such as my GIS MapBox project, my Skyrim dog follower mod, or my Dice Roll simulator PDF reader. Within some of my projects I also have various videos and art that I've created, such as my website detailing coffee's threat of extinction. I have also had the pleasure of working on teams with extraordinarily talented peers for some of my larger projects such as DATA ENTRY: PORTAL, a Sci-Fi Mystery VR game! Whether I'm setting out on a team or flying solo, my aim on every project is to challenge myself and learn something new.
                    </p> 
